...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<jekyll-mentions>.freeze, ["= 1.0.0"])
      ...
      s.add_runtime_dependency(%q<github-pages-health-check>.freeze, ["= 0.6.1"])
      s.add_runtime_dependency(%q<jekyll-coffeescript>.freeze, ["= 1.0.1"])
      s.add_runtime_dependency(%q<jekyll-seo-tag>.freeze, ["= 1.0.0"])
      ...
      s.add_dependency(%q<jekyll-mentions>.freeze, ["= 1.0.0"])
      ...
      s.add_dependency(%q<github-pages-health-check>.freeze, ["= 0.6.1"])
      s.add_dependency(%q<jekyll-coffeescript>.freeze, ["= 1.0.1"])
      s.add_dependency(%q<jekyll-seo-tag>.freeze, ["= 1.0.0"])
